...
CFLAGS  = -g -Wno-undef -marm -mtune=cortex-a7 -mfpu=neon-vfpv4  -march=armv7ve+simd -mfloat-abi=hard -ffunction-sections -fdata-sections  -DUSING_GENERATED_CONFIG_H
...
$(objects)/SDL_picocfg_mmiyoo.lo: /root/workspace/sdl2_miyoo/src/cfg/SDL_picocfg_mmiyoo.c $(objects)/.created
	$(RUN_CMD_CC)$(LIBTOOL) --tag=CC --mode=compile $(CC) $(CFLAGS) $(EXTRA_CFLAGS) -MMD -MT $@ -c $< -o $@
